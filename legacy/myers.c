...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    struct futhark_u16_1d *read_value_7990;
    int64_t read_shape_7991[1];
    int16_t *read_arr_7992 = NULL;
    
    errno = 0;
    if (read_array(&u16_info, (void **) &read_arr_7992, read_shape_7991, 1) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 0, "[]",
              u16_info.type_name, strerror(errno));
    
    struct futhark_u16_1d *read_value_7993;
    int64_t read_shape_7994[1];
    int16_t *read_arr_7995 = NULL;
    
    errno = 0;
    if (read_array(&u16_info, (void **) &read_arr_7995, read_shape_7994, 1) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1, "[]",
              u16_info.type_name, strerror(errno));
    ...
    if (perform_warmup) {
        ...
        assert((read_value_7990 = futhark_new_u16_1d(ctx, read_arr_7992,
                                                     read_shape_7991[0])) != 0);
        assert((read_value_7993 = futhark_new_u16_1d(ctx, read_arr_7995,
                                                     read_shape_7994[0])) != 0);
        ;
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        r = futhark_entry_main(ctx, &result_7997, read_value_7990,
                               read_value_7993, read_value_7996);
        if (r != 0)
        ...
        assert(futhark_free_u16_1d(ctx, read_value_7990) == 0);
        assert(futhark_free_u16_1d(ctx, read_value_7993) == 0);
        ;
...
const char *cuda_program[] =
           {"typedef char int8_t;\ntypedef short int16_t;\ntypedef int int32_t;\ntypedef long int64_t;\ntypedef unsigned char uint8_t;\ntypedef unsigned short uint16_t;\ntypedef unsigned int uint32_t;\ntypedef unsigned long long uint64_t;\ntypedef uint8_t uchar;\ntypedef uint16_t ushort;\ntypedef uint32_t uint;\ntypedef uint64_t ulong;\n#define __kernel extern \"C\" __global__ __launch_bounds__(MAX_THREADS_PER_BLOCK)\n#define __global\n#define __local\n#define __private\n#define __constant\n#define __write_only\n#define __read_only\nstatic inline int get_group_id_fn(int block_dim0, int block_dim1,\n                                  int block_dim2, int d)\n{\n    switch (d) {\n        \n      case 0:\n        d = block_dim0;\n        break;\n        \n      case 1:\n        d = block_dim1;\n        break;\n        \n      case 2:\n        d = block_dim2;\n        break;\n    }\n    switch (d) {\n        \n      case 0:\n        return blockIdx.x;\n        \n      case 1:\n        return blockIdx.y;\n        \n      case 2:\n        return blockIdx.z;\n        \n      default:\n        return 0;\n    }\n}\n#define get_group_id(d) get_group_id_fn(block_dim0, block_dim1, block_dim2, d)\nstatic inline int get_num_groups_fn(int block_dim0, int block_dim1,\n                                    int block_dim2, int d)\n{\n    switch (d) {\n        \n      case 0:\n        d = block_dim0;\n        break;\n        \n      case 1:\n        d = block_dim1;\n        break;\n        \n      case 2:\n        d = block_dim2;\n        break;\n    }\n    switch (d) {\n        \n      case 0:\n        return gridDim.x;\n        \n      case 1:\n        return gridDim.y;\n        \n      case 2:\n        return gridDim.z;\n        \n      default:\n        return 0;\n    }\n}\n#define get_num_groups(d) get_num_groups_fn(block_dim0, block_dim1, block_dim2, d)\nstatic inline int get_local_id(int d)\n{\n    switch (d) {\n        \n      case 0:\n        return threadIdx.x;\n        \n      case 1:\n        return threadIdx.y;\n        \n      case 2:\n        return threadIdx.z;\n        \n      defau",
            ...
            "_f64(double x)\n{\n    return x;\n}\n__kernel void map_7844(int32_t o_7745, int64_t res_7762,\n                       int32_t index_primexp_7801, __global\n                       unsigned char *bs_mem_7886, __global\n                       unsigned char *mem_7898, __global\n                       unsigned char *scs_mem_7904, __global\n                       unsigned char *mvs_mem_7906, __global\n                       unsigned char *pvs_mem_7908, __global\n                       unsigned char *mem_7911, __global\n                       unsigned char *mem_7914, __global\n                       unsigned char *mem_7917)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t wave_sizze_7955;\n    int32_t group_sizze_7956;\n    int32_t gtid_7837;\n    int32_t global_tid_7844;\n    int32_t local_tid_7845;\n    int32_t group_id_7846;\n    \n    global_tid_7844 = get_global_id(0);\n    local_tid_7845 = get_local_id(0);\n    group_sizze_7956 = get_local_size(0);\n    wave_sizze_7955 = LOCKSTEP_WIDTH;\n    group_id_7846 = get_group_id(0);\n    gtid_7837 = global_tid_7844;\n    \n    int64_t x_7848;\n    int64_t x_7849;\n    int32_t x_7850;\n    int32_t i_7851;\n    int16_t arg_7852;\n    int32_t res_7853;\n    int64_t res_7854;\n    int64_t res_7855;\n    int64_t x_7856;\n    int64_t x_7857;\n    int64_t x_7858;\n    int64_t res_7859;\n    int64_t complement_arg_7860;\n    int64_t y_7861;\n    int64_t res_7862;\n    int64_t res_7863;\n    int64_t arg_7864;\n    bool res_7865;\n    int32_t res_7866;\n    int64_t x_7872;\n    int64_t res_7873;\n    int64_t x_7874;\n    int64_t complement_arg_7875;\n    int64_t y_7876;\n    int64_t res_7877;\n    int64_t res_7878;\n    \n    if (slt32(gtid_7837, o_7745)) {\n        x_7848 = *(__global int64_t *) &mvs_mem_7906[gtid_7837 * 8];\n        x_7849 = *(__global int64_t *) &pvs_mem_7908[gtid_7837 * 8];\n        x_7850 = *(__global int32_t *) &scs_mem_7904[gtid_7837 * 4];\n        i_7851 = index_primexp_7801 + gtid_7837;\n        arg_7852 = *(__glo",
            "bal int16_t *) &bs_mem_7886[i_7851 * 2];\n        res_7853 = zext_i16_i32(arg_7852);\n        res_7854 = *(__global int64_t *) &mem_7898[res_7853 * 8];\n        res_7855 = x_7848 | res_7854;\n        x_7856 = x_7849 & res_7854;\n        x_7857 = x_7849 + x_7856;\n        x_7858 = x_7849 ^ x_7857;\n        res_7859 = res_7854 | x_7858;\n        complement_arg_7860 = x_7849 | res_7859;\n        y_7861 = ~complement_arg_7860;\n        res_7862 = x_7848 | y_7861;\n        res_7863 = x_7849 & res_7859;\n        arg_7864 = res_7762 & res_7862;\n        res_7865 = itob_i64_bool(arg_7864);\n        if (res_7865) {\n            int32_t res_7867 = 1 + x_7850;\n            \n            res_7866 = res_7867;\n        } else {\n            int64_t arg_7868;\n            bool res_7869;\n            int32_t res_7870;\n            \n            arg_7868 = res_7762 & res_7863;\n            res_7869 = itob_i64_bool(arg_7868);\n            if (res_7869) {\n                int32_t res_7871 = x_7850 - 1;\n                \n                res_7870 = res_7871;\n            } else {\n                res_7870 = x_7850;\n            }\n            res_7866 = res_7870;\n        }\n        x_7872 = res_7862 << 1;\n        res_7873 = 1 | x_7872;\n        x_7874 = res_7863 << 1;\n        complement_arg_7875 = res_7855 | res_7873;\n        y_7876 = ~complement_arg_7875;\n        res_7877 = x_7874 | y_7876;\n        res_7878 = res_7855 & res_7873;\n    }\n    if (slt32(gtid_7837, o_7745)) {\n        *(__global int64_t *) &mem_7911[gtid_7837 * 8] = res_7878;\n    }\n    if (slt32(gtid_7837, o_7745)) {\n        *(__global int64_t *) &mem_7914[gtid_7837 * 8] = res_7877;\n    }\n    if (slt32(gtid_7837, o_7745)) {\n        *(__global int32_t *) &mem_7917[gtid_7837 * 4] = res_7866;\n    }\n}\n__kernel void replicate_7928(int32_t sizze_7741, int32_t o_7745, __global\n                             unsigned char *mem_7889)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t replicate_gtid_7928;\n    int32_t",
            " replicate_ltid_7929;\n    int32_t replicate_gid_7930;\n    \n    replicate_gtid_7928 = get_global_id(0);\n    replicate_ltid_7929 = get_local_id(0);\n    replicate_gid_7930 = get_group_id(0);\n    if (slt32(replicate_gtid_7928, o_7745)) {\n        *(__global int32_t *) &mem_7889[replicate_gtid_7928 * 4] = sizze_7741;\n    }\n}\n__kernel void replicate_7933(int32_t o_7745, __global unsigned char *mem_7892)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t replicate_gtid_7933;\n    int32_t replicate_ltid_7934;\n    int32_t replicate_gid_7935;\n    \n    replicate_gtid_7933 = get_global_id(0);\n    replicate_ltid_7934 = get_local_id(0);\n    replicate_gid_7935 = get_group_id(0);\n    if (slt32(replicate_gtid_7933, o_7745)) {\n        *(__global int64_t *) &mem_7892[replicate_gtid_7933 * 8] = 0;\n    }\n}\n__kernel void replicate_7938(int32_t o_7745, __global unsigned char *mem_7895)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t replicate_gtid_7938;\n    int32_t replicate_ltid_7939;\n    int32_t replicate_gid_7940;\n    \n    replicate_gtid_7938 = get_global_id(0);\n    replicate_ltid_7939 = get_local_id(0);\n    replicate_gid_7940 = get_group_id(0);\n    if (slt32(replicate_gtid_7938, o_7745)) {\n        *(__global int64_t *) &mem_7895[replicate_gtid_7938 * 8] = -1;\n    }\n}\n__kernel void replicate_7943(__global unsigned char *mem_7898)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t replicate_gtid_7943;\n    int32_t replicate_ltid_7944;\n    int32_t replicate_gid_7945;\n    \n    replicate_gtid_7943 = get_global_id(0);\n    replicate_ltid_7944 = get_local_id(0);\n    replicate_gid_7945 = get_group_id(0);\n    if (slt32(replicate_gtid_7943, 256)) {\n        *(__global int64_t *) &mem_7898[replicate_gtid_7943 * 8] = 0;\n    }\n}\n",
            NULL};
...
static const char *size_names[] = {"main.group_size_7838",
                                   "main.group_size_7931",
                                   "main.group_size_7936",
                                   "main.group_size_7941",
                                   "main.group_size_7946"};
static const char *size_vars[] = {"mainzigroup_sizze_7838",
                                  "mainzigroup_sizze_7931",
                                  "mainzigroup_sizze_7936",
                                  "mainzigroup_sizze_7941",
                                  "mainzigroup_sizze_7946"};
...
struct sizes {
    size_t mainzigroup_sizze_7838;
    size_t mainzigroup_sizze_7931;
    size_t mainzigroup_sizze_7936;
    size_t mainzigroup_sizze_7941;
    size_t mainzigroup_sizze_7946;
} ;
struct futhark_context_config {
...
struct futhark_context {
    ...
    CUfunction map_7844;
    CUfunction replicate_7928;
    CUfunction replicate_7933;
    CUfunction replicate_7938;
    CUfunction replicate_7943;
...
struct futhark_context *futhark_context_new(struct futhark_context_config *cfg)
{
    ...
    CUDA_SUCCEED(cuModuleGetFunction(&ctx->map_7844, ctx->cuda.module,
                                     "map_7844"));
    CUDA_SUCCEED(cuModuleGetFunction(&ctx->replicate_7928, ctx->cuda.module,
                                     "replicate_7928"));
    CUDA_SUCCEED(cuModuleGetFunction(&ctx->replicate_7933, ctx->cuda.module,
                                     "replicate_7933"));
    CUDA_SUCCEED(cuModuleGetFunction(&ctx->replicate_7938, ctx->cuda.module,
                                     "replicate_7938"));
    CUDA_SUCCEED(cuModuleGetFunction(&ctx->replicate_7943, ctx->cuda.module,
                                     "replicate_7943"));
    ctx->sizes.mainzigroup_sizze_7838 = cfg->sizes[0];
    ctx->sizes.mainzigroup_sizze_7931 = cfg->sizes[1];
    ctx->sizes.mainzigroup_sizze_7936 = cfg->sizes[2];
    ctx->sizes.mainzigroup_sizze_7941 = cfg->sizes[3];
    ctx->sizes.mainzigroup_sizze_7946 = cfg->sizes[4];
    return ctx;
}
void futhark_context_free(struct futhark_context *ctx)
{
...
static int futrts_main(struct futhark_context *ctx,
                       int64_t *out_out_memsizze_7957,
                       struct memblock_device *out_mem_p_7958,
                       int32_t *out_out_arrsizze_7959, int64_t a_mem_sizze_7883,
                       struct memblock_device a_mem_7884,
                       int64_t bs_mem_sizze_7885,
                       struct memblock_device bs_mem_7886, int32_t sizze_7741,
                       int32_t sizze_7742, int32_t o_7745);
static inline int8_t add8(int8_t x, int8_t y)
{
    return x + y;
}
...
static int futrts_main(struct futhark_context *ctx,
                       ...
                       int32_t sizze_7742, int32_t o_7745)
{
    int64_t out_memsizze_7926;
    struct memblock_device out_mem_7925;
    
    out_mem_7925.references = NULL;
    
    int32_t out_arrsizze_7927;
    bool bounds_invalid_upwards_7746 = slt32(o_7745, 0);
    bool eq_x_zz_7747 = 0 == o_7745;
    bool not_p_7748 = !bounds_invalid_upwards_7746;
    bool p_and_eq_x_y_7749 = eq_x_zz_7747 && not_p_7748;
    bool dim_zzero_7750 = bounds_invalid_upwards_7746 || p_and_eq_x_y_7749;
    bool both_empty_7751 = eq_x_zz_7747 && dim_zzero_7750;
    bool empty_or_match_7755 = not_p_7748 || both_empty_7751;
    bool empty_or_match_cert_7756;
    
    if (!empty_or_match_7755) {
        ctx->error = msgprintf("Error at %s:\n%s%s%s%d%s%s\n",
                               "legacy/myers.fut:12:1-38:23 -> legacy/myers.fut:14:13-25 -> /futlib/array.fut:66:1-67:19",
                               "Function return value does not match shape of type ",
                               "*", "[", o_7745, "]", "t");
        if (memblock_unref_device(ctx, &out_mem_7925, "out_mem_7925") != 0)
            return 1;
        return 1;
    }
    
    int64_t binop_x_7888 = sext_i32_i64(o_7745);
    int64_t bytes_7887 = 4 * binop_x_7888;
    struct memblock_device mem_7889;
    
    mem_7889.references = NULL;
    if (memblock_alloc_device(ctx, &mem_7889, bytes_7887, "mem_7889"))
        return 1;
    
    int32_t group_sizze_7931;
    
    group_sizze_7931 = ctx->sizes.mainzigroup_sizze_7931;
    
    int32_t num_groups_7932;
    
    num_groups_7932 = squot32(o_7745 + sext_i32_i32(group_sizze_7931) - 1,
                              sext_i32_i32(group_sizze_7931));
    
    CUdeviceptr kernel_arg_7963 = mem_7889.mem;
    
    if ((((((1 && num_groups_7932 != 0) && 1 != 0) && 1 != 0) &&
          group_sizze_7931 != 0) && 1 != 0) && 1 != 0) {
        int perm[3] = {0, 1, 2};
        ...
        grid[perm[0]] = num_groups_7932;
        grid[perm[1]] = 1;
        grid[perm[2]] = 1;
        
        void *kernel_args_7960[] = {&sizze_7741, &o_7745, &kernel_arg_7963};
        int64_t time_start_7961 = 0, time_end_7962 = 0;
        
        if (ctx->debugging) {
            fprintf(stderr, "Launching %s with grid size (", "replicate_7928");
            fprintf(stderr, "%d", num_groups_7932);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ") and block size (");
            fprintf(stderr, "%d", group_sizze_7931);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ").\n");
            time_start_7961 = get_wall_time();
        }
        CUDA_SUCCEED(cuLaunchKernel(ctx->replicate_7928, grid[0], grid[1],
                                    grid[2], group_sizze_7931, 1, 1, 0, NULL,
                                    kernel_args_7960, NULL));
        if (ctx->debugging) {
            CUDA_SUCCEED(cuCtxSynchronize());
            time_end_7962 = get_wall_time();
            fprintf(stderr, "Kernel %s runtime: %ldus\n", "replicate_7928",
                    time_end_7962 - time_start_7961);
        }
    }
    
    int64_t bytes_7890 = 8 * binop_x_7888;
    struct memblock_device mem_7892;
    
    mem_7892.references = NULL;
    if (memblock_alloc_device(ctx, &mem_7892, bytes_7890, "mem_7892"))
        return 1;
    
    int32_t group_sizze_7936;
    
    group_sizze_7936 = ctx->sizes.mainzigroup_sizze_7936;
    
    int32_t num_groups_7937;
    
    num_groups_7937 = squot32(o_7745 + sext_i32_i32(group_sizze_7936) - 1,
                              sext_i32_i32(group_sizze_7936));
    
    CUdeviceptr kernel_arg_7967 = mem_7892.mem;
    
    if ((((((1 && num_groups_7937 != 0) && 1 != 0) && 1 != 0) &&
          group_sizze_7936 != 0) && 1 != 0) && 1 != 0) {
        int perm[3] = {0, 1, 2};
        ...
        grid[perm[0]] = num_groups_7937;
        grid[perm[1]] = 1;
        grid[perm[2]] = 1;
        
        void *kernel_args_7964[] = {&o_7745, &kernel_arg_7967};
        int64_t time_start_7965 = 0, time_end_7966 = 0;
        
        if (ctx->debugging) {
            fprintf(stderr, "Launching %s with grid size (", "replicate_7933");
            fprintf(stderr, "%d", num_groups_7937);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ") and block size (");
            fprintf(stderr, "%d", group_sizze_7936);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ").\n");
            time_start_7965 = get_wall_time();
        }
        CUDA_SUCCEED(cuLaunchKernel(ctx->replicate_7933, grid[0], grid[1],
                                    grid[2], group_sizze_7936, 1, 1, 0, NULL,
                                    kernel_args_7964, NULL));
        if (ctx->debugging) {
            CUDA_SUCCEED(cuCtxSynchronize());
            time_end_7966 = get_wall_time();
            fprintf(stderr, "Kernel %s runtime: %ldus\n", "replicate_7933",
                    time_end_7966 - time_start_7965);
        }
    }
    
    struct memblock_device mem_7895;
    
    mem_7895.references = NULL;
    if (memblock_alloc_device(ctx, &mem_7895, bytes_7890, "mem_7895"))
        return 1;
    
    int32_t group_sizze_7941;
    
    group_sizze_7941 = ctx->sizes.mainzigroup_sizze_7941;
    
    int32_t num_groups_7942;
    
    num_groups_7942 = squot32(o_7745 + sext_i32_i32(group_sizze_7941) - 1,
                              sext_i32_i32(group_sizze_7941));
    
    CUdeviceptr kernel_arg_7971 = mem_7895.mem;
    
    if ((((((1 && num_groups_7942 != 0) && 1 != 0) && 1 != 0) &&
          group_sizze_7941 != 0) && 1 != 0) && 1 != 0) {
        int perm[3] = {0, 1, 2};
        ...
        grid[perm[0]] = num_groups_7942;
        grid[perm[1]] = 1;
        grid[perm[2]] = 1;
        
        void *kernel_args_7968[] = {&o_7745, &kernel_arg_7971};
        int64_t time_start_7969 = 0, time_end_7970 = 0;
        
        if (ctx->debugging) {
            fprintf(stderr, "Launching %s with grid size (", "replicate_7938");
            fprintf(stderr, "%d", num_groups_7942);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ") and block size (");
            fprintf(stderr, "%d", group_sizze_7941);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ").\n");
            time_start_7969 = get_wall_time();
        }
        CUDA_SUCCEED(cuLaunchKernel(ctx->replicate_7938, grid[0], grid[1],
                                    grid[2], group_sizze_7941, 1, 1, 0, NULL,
                                    kernel_args_7968, NULL));
        if (ctx->debugging) {
            CUDA_SUCCEED(cuCtxSynchronize());
            time_end_7970 = get_wall_time();
            fprintf(stderr, "Kernel %s runtime: %ldus\n", "replicate_7938",
                    time_end_7970 - time_start_7969);
        }
    }
    
    int64_t arg_7760 = zext_i32_i64(sizze_7741);
    int64_t y_7761 = arg_7760 - 1;
    int64_t res_7762 = 1 << y_7761;
    bool empty_or_match_cert_7763;
    
    if (!empty_or_match_7755) {
        ctx->error = msgprintf("Error at %s:\n%s%s%s%d%s%s\n",
                               "legacy/myers.fut:12:1-38:23 -> legacy/myers.fut:18:15-20 -> /futlib/array.fut:61:1-62:12",
                               "Function return value does not match shape of type ",
                               "*", "[", o_7745, "]", "intrinsics.i32");
        if (memblock_unref_device(ctx, &mem_7895, "mem_7895") != 0)
            return 1;
        if (memblock_unref_device(ctx, &mem_7892, "mem_7892") != 0)
            return 1;
        if (memblock_unref_device(ctx, &mem_7889, "mem_7889") != 0)
            return 1;
        if (memblock_unref_device(ctx, &out_mem_7925, "out_mem_7925") != 0)
            return 1;
        return 1;
    ...
    struct memblock_device mem_7898;
    
    mem_7898.references = NULL;
    if (memblock_alloc_device(ctx, &mem_7898, 2048, "mem_7898"))
        return 1;
    
    int32_t group_sizze_7946;
    
    group_sizze_7946 = ctx->sizes.mainzigroup_sizze_7946;
    
    int32_t num_groups_7947;
    
    num_groups_7947 = squot32(256 + sext_i32_i32(group_sizze_7946) - 1,
                              sext_i32_i32(group_sizze_7946));
    
    CUdeviceptr kernel_arg_7975 = mem_7898.mem;
    
    if ((((((1 && num_groups_7947 != 0) && 1 != 0) && 1 != 0) &&
          group_sizze_7946 != 0) && 1 != 0) && 1 != 0) {
        int perm[3] = {0, 1, 2};
        ...
        grid[perm[0]] = num_groups_7947;
        grid[perm[1]] = 1;
        grid[perm[2]] = 1;
        
        void *kernel_args_7972[] = {&kernel_arg_7975};
        int64_t time_start_7973 = 0, time_end_7974 = 0;
        
        if (ctx->debugging) {
            fprintf(stderr, "Launching %s with grid size (", "replicate_7943");
            fprintf(stderr, "%d", num_groups_7947);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ") and block size (");
            fprintf(stderr, "%d", group_sizze_7946);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ", ");
            fprintf(stderr, "%d", 1);
            fprintf(stderr, ").\n");
            time_start_7973 = get_wall_time();
        }
        CUDA_SUCCEED(cuLaunchKernel(ctx->replicate_7943, grid[0], grid[1],
                                    grid[2], group_sizze_7946, 1, 1, 0, NULL,
                                    kernel_args_7972, NULL));
        if (ctx->debugging) {
            CUDA_SUCCEED(cuCtxSynchronize());
            time_end_7974 = get_wall_time();
            fprintf(stderr, "Kernel %s runtime: %ldus\n", "replicate_7943",
                    time_end_7974 - time_start_7973);
        }
    }
    for (int32_t i_7768 = 0; i_7768 < sizze_7741; i_7768++) {
        int16_t read_res_7976;
        
        CUDA_SUCCEED(cuMemcpyDtoH(&read_res_7976, a_mem_7884.mem + i_7768 * 2,
                                  sizeof(int16_t)));
        
        int16_t arg_7773 = read_res_7976;
        int32_t res_7774 = zext_i16_i32(arg_7773);
        bool x_7775 = sle32(0, res_7774);
        bool y_7776 = slt32(res_7774, 256);
        bool bounds_check_7777 = x_7775 && y_7776;
        bool index_certs_7778;
        
        if (!bounds_check_7777) {
            ctx->error = msgprintf("Error at %s:\n%s%d%s%d%s\n",
                                   "legacy/myers.fut:12:1-38:23 -> legacy/myers.fut:23:27-36",
                                   "Index [", res_7774,
                                   "] out of bounds for array of shape [", 256,
                                   "].");
            if (memblock_unref_device(ctx, &mem_7898, "mem_7898") != 0)
                return 1;
            if (memblock_unref_device(ctx, &mem_7895, "mem_7895") != 0)
                return 1;
            if (memblock_unref_device(ctx, &mem_7892, "mem_7892") != 0)
        ...
        int64_t read_res_7977;
        
        CUDA_SUCCEED(cuMemcpyDtoH(&read_res_7977, mem_7898.mem + res_7774 * 8,
                                  sizeof(int64_t)));
        
        int64_t x_7779 = read_res_7977;
        int64_t arg_7780 = zext_i32_i64(i_7768);
        int64_t y_7781 = 1 << arg_7780;
        int64_t lw_val_7782 = x_7779 | y_7781;
        int64_t write_tmp_7978 = lw_val_7782;
        
        CUDA_SUCCEED(cuMemcpyHtoD(mem_7898.mem + res_7774 * 8, &write_tmp_7978,
                                  sizeof(int64_t)));
    }
    
    int32_t s_sign_7784 = (o_7745 > 0) - (o_7745 < 0);
    bool bounds_invalid_upwards_7785 = slt32(sizze_7742, 0);
    bool step_wrong_dir_7786 = s_sign_7784 == -1;
    bool step_invalid_7787 = eq_x_zz_7747 || step_wrong_dir_7786;
    bool range_invalid_7788 = bounds_invalid_upwards_7785 || step_invalid_7787;
    int32_t pos_step_7789 = o_7745 * s_sign_7784;
    int32_t num_elems_7790;
    
    if (range_invalid_7788) {
        num_elems_7790 = 0;
    } else {
        int32_t y_7791 = pos_step_7789 - 1;
        int32_t x_7792 = sizze_7742 + y_7791;
        int32_t x_7793 = squot32(x_7792, pos_step_7789);
        
        num_elems_7790 = x_7793;
    }
    
    bool loop_nonempty_7880 = slt32(0, num_elems_7790);
    int32_t group_sizze_7839;
    
    group_sizze_7839 = ctx->sizes.mainzigroup_sizze_7838;
    
    int32_t y_7840 = group_sizze_7839 - 1;
    int32_t x_7841 = o_7745 + y_7840;
    int32_t num_groups_7842;
    
    if (loop_nonempty_7880) {
        int32_t x_7881 = squot32(x_7841, group_sizze_7839);
        
        num_groups_7842 = x_7881;
    } else {
        num_groups_7842 = 0;
    }
    
    int32_t num_threads_7843 = group_sizze_7839 * num_groups_7842;
    struct memblock_device res_mem_7919;
    
    res_mem_7919.references = NULL;
    
    struct memblock_device res_mem_7921;
    
    res_mem_7921.references = NULL;
    
    struct memblock_device res_mem_7923;
    
    res_mem_7923.references = NULL;
    
    struct memblock_device scs_mem_7904;
    
    scs_mem_7904.references = NULL;
    
    struct memblock_device mvs_mem_7906;
    
    mvs_mem_7906.references = NULL;
    
    struct memblock_device pvs_mem_7908;
    
    pvs_mem_7908.references = NULL;
    if (memblock_set_device(ctx, &scs_mem_7904, &mem_7889, "mem_7889") != 0)
        return 1;
    if (memblock_set_device(ctx, &mvs_mem_7906, &mem_7892, "mem_7892") != 0)
        return 1;
    if (memblock_set_device(ctx, &pvs_mem_7908, &mem_7895, "mem_7895") != 0)
        return 1;
    for (int32_t i_7800 = 0; i_7800 < num_elems_7790; i_7800++) {
        int32_t index_primexp_7801 = o_7745 * i_7800;
        struct memblock_device mem_7911;
        
        mem_7911.references = NULL;
        if (memblock_alloc_device(ctx, &mem_7911, bytes_7890, "mem_7911"))
            return 1;
        
        struct memblock_device mem_7914;
        
        mem_7914.references = NULL;
        if (memblock_alloc_device(ctx, &mem_7914, bytes_7890, "mem_7914"))
            return 1;
        
        struct memblock_device mem_7917;
        
        mem_7917.references = NULL;
        if (memblock_alloc_device(ctx, &mem_7917, bytes_7887, "mem_7917"))
            return 1;
        
        CUdeviceptr kernel_arg_7982 = bs_mem_7886.mem;
        CUdeviceptr kernel_arg_7983 = mem_7898.mem;
        CUdeviceptr kernel_arg_7984 = scs_mem_7904.mem;
        CUdeviceptr kernel_arg_7985 = mvs_mem_7906.mem;
        CUdeviceptr kernel_arg_7986 = pvs_mem_7908.mem;
        CUdeviceptr kernel_arg_7987 = mem_7911.mem;
        CUdeviceptr kernel_arg_7988 = mem_7914.mem;
        CUdeviceptr kernel_arg_7989 = mem_7917.mem;
        
        if ((((((1 && num_groups_7842 != 0) && 1 != 0) && 1 != 0) &&
              group_sizze_7839 != 0) && 1 != 0) && 1 != 0) {
            int perm[3] = {0, 1, 2};
            ...
            grid[perm[0]] = num_groups_7842;
            grid[perm[1]] = 1;
            grid[perm[2]] = 1;
            
            void *kernel_args_7979[] = {&o_7745, &res_7762, &index_primexp_7801,
                                        &kernel_arg_7982, &kernel_arg_7983,
                                        &kernel_arg_7984, &kernel_arg_7985,
                                        &kernel_arg_7986, &kernel_arg_7987,
                                        &kernel_arg_7988, &kernel_arg_7989};
            int64_t time_start_7980 = 0, time_end_7981 = 0;
            
            if (ctx->debugging) {
                fprintf(stderr, "Launching %s with grid size (", "map_7844");
                fprintf(stderr, "%d", num_groups_7842);
                fprintf(stderr, ", ");
                fprintf(stderr, "%d", 1);
                fprintf(stderr, ", ");
                fprintf(stderr, "%d", 1);
                fprintf(stderr, ") and block size (");
                fprintf(stderr, "%d", group_sizze_7839);
                fprintf(stderr, ", ");
                fprintf(stderr, "%d", 1);
                fprintf(stderr, ", ");
                fprintf(stderr, "%d", 1);
                fprintf(stderr, ").\n");
                time_start_7980 = get_wall_time();
            }
            CUDA_SUCCEED(cuLaunchKernel(ctx->map_7844, grid[0], grid[1],
                                        grid[2], group_sizze_7839, 1, 1, 0,
                                        NULL, kernel_args_7979, NULL));
            if (ctx->debugging) {
                CUDA_SUCCEED(cuCtxSynchronize());
                time_end_7981 = get_wall_time();
                fprintf(stderr, "Kernel %s runtime: %ldus\n", "map_7844",
                        time_end_7981 - time_start_7980);
            }
        }
        
        struct memblock_device scs_mem_tmp_7949;
        
        scs_mem_tmp_7949.references = NULL;
        if (memblock_set_device(ctx, &scs_mem_tmp_7949, &mem_7917,
                                "mem_7917") != 0)
            return 1;
        
        struct memblock_device mvs_mem_tmp_7950;
        
        mvs_mem_tmp_7950.references = NULL;
        if (memblock_set_device(ctx, &mvs_mem_tmp_7950, &mem_7911,
                                "mem_7911") != 0)
            return 1;
        
        struct memblock_device pvs_mem_tmp_7951;
        
        pvs_mem_tmp_7951.references = NULL;
        if (memblock_set_device(ctx, &pvs_mem_tmp_7951, &mem_7914,
                                "mem_7914") != 0)
            return 1;
        if (memblock_set_device(ctx, &scs_mem_7904, &scs_mem_tmp_7949,
                                "scs_mem_tmp_7949") != 0)
            return 1;
        if (memblock_set_device(ctx, &mvs_mem_7906, &mvs_mem_tmp_7950,
                                "mvs_mem_tmp_7950") != 0)
            return 1;
        if (memblock_set_device(ctx, &pvs_mem_7908, &pvs_mem_tmp_7951,
                                "pvs_mem_tmp_7951") != 0)
            return 1;
        if (memblock_unref_device(ctx, &pvs_mem_tmp_7951, "pvs_mem_tmp_7951") !=
            0)
            return 1;
        if (memblock_unref_device(ctx, &mvs_mem_tmp_7950, "mvs_mem_tmp_7950") !=
            0)
            return 1;
        if (memblock_unref_device(ctx, &scs_mem_tmp_7949, "scs_mem_tmp_7949") !=
            0)
            return 1;
        if (memblock_unref_device(ctx, &mem_7917, "mem_7917") != 0)
            return 1;
        if (memblock_unref_device(ctx, &mem_7914, "mem_7914") != 0)
            return 1;
        if (memblock_unref_device(ctx, &mem_7911, "mem_7911") != 0)
            return 1;
    }
    if (memblock_set_device(ctx, &res_mem_7919, &scs_mem_7904,
                            "scs_mem_7904") != 0)
        return 1;
    if (memblock_set_device(ctx, &res_mem_7921, &mvs_mem_7906,
                            "mvs_mem_7906") != 0)
        return 1;
    if (memblock_set_device(ctx, &res_mem_7923, &pvs_mem_7908,
                            "pvs_mem_7908") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_7889, "mem_7889") != 0)
        return 1;
    ...
    if (memblock_unref_device(ctx, &mem_7898, "mem_7898") != 0)
        return 1;
    out_arrsizze_7927 = o_7745;
    out_memsizze_7926 = bytes_7887;
    if (memblock_set_device(ctx, &out_mem_7925, &res_mem_7919,
                            "res_mem_7919") != 0)
        return 1;
    *out_out_memsizze_7957 = out_memsizze_7926;
    (*out_mem_p_7958).references = NULL;
    if (memblock_set_device(ctx, &*out_mem_p_7958, &out_mem_7925,
                            "out_mem_7925") != 0)
        return 1;
    *out_out_arrsizze_7959 = out_arrsizze_7927;
    if (memblock_unref_device(ctx, &pvs_mem_7908, "pvs_mem_7908") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mvs_mem_7906, "mvs_mem_7906") != 0)
        return 1;
    if (memblock_unref_device(ctx, &scs_mem_7904, "scs_mem_7904") != 0)
        return 1;
    if (memblock_unref_device(ctx, &res_mem_7923, "res_mem_7923") != 0)
        return 1;
    if (memblock_unref_device(ctx, &res_mem_7921, "res_mem_7921") != 0)
        return 1;
    if (memblock_unref_device(ctx, &res_mem_7919, "res_mem_7919") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_7898, "mem_7898") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_7895, "mem_7895") != 0)
...
int futhark_entry_main(struct futhark_context *ctx,
                       ...
                       struct futhark_u16_1d *in1, const int32_t in2)
{
    int64_t a_mem_sizze_7883;
    struct memblock_device a_mem_7884;
    
    a_mem_7884.references = NULL;
    
    int64_t bs_mem_sizze_7885;
    struct memblock_device bs_mem_7886;
    
    bs_mem_7886.references = NULL;
    ...
    lock_lock(&ctx->lock);
    a_mem_7884 = in0->mem;
    a_mem_sizze_7883 = in0->mem.size;
    sizze_7741 = in0->shape[0];
    bs_mem_7886 = in1->mem;
    bs_mem_sizze_7885 = in1->mem.size;
    sizze_7742 = in1->shape[0];
    o_7745 = in2;
    
    int ret = futrts_main(ctx, &out_memsizze_7926, &out_mem_7925,
                          &out_arrsizze_7927, a_mem_sizze_7883, a_mem_7884,
                          bs_mem_sizze_7885, bs_mem_7886, sizze_7741,
                          sizze_7742, o_7745);
    
    if (ret == 0) {
        assert((*out0 = malloc(sizeof(struct futhark_i32_1d))) != NULL);
        (*out0)->mem = out_mem_7925;
        (*out0)->shape[0] = out_arrsizze_7927;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
